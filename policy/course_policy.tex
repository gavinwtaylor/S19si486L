...
\item Projects: There will be many projects involving programming a robot.
  These will be performed in groups of 2 or 3, and will end with an in-class
  demonstration.  You may use any source for help, and discuss them with
  anybody, but \textbf{all submitted work must be your group's}, and all help
  must be documented.
...
\item \textbf{25\% Mid-term Exams} (2) - Mid-terms are written, with no
  practical component.  Bring a calculator, we do math in here.
\item \textbf{40\% Programming Projects} - Detailed instructions for the
